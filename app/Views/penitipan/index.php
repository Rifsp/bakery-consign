...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Penitipan</h1>
        <a href="<?= base_url('/penitipan/create') ?>" class="btn btn-primary btn-sm">
            <i class="fas fa-plus"></i> Buat Penitipan
        </a>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="form-inline">
                ...
                <a href="<?= base_url('/penitipan') ?>" class="btn btn-outline-secondary"><i class="fas fa-undo"></i></a>
            </div>
        </div>
        <div class="card-body">
...
async function loadData(page) {
    ...
    const url = '<?= base_url('/penitipan/fetch') ?>?' + params.toString();
